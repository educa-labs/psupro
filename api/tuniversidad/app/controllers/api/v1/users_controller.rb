class Api::V1::UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:email, :password, :password_confirmation,:first_name,:last_name,:city_id,:phone,:writer,:admin,:preuniversity,:notifications,:level_id,:image_data,:image_name,:tutorial,:ranking,:nem)
  end
